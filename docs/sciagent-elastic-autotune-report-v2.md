...
Indexed working-set compaction merged as PR #1096 at master commit `928c0e5e2997a9281d08ab01812c33dbdd3353ca`, then CSR-SoA TinyScan merged as PR #1095 at `ed0e814073854fb9d74d92cff46372e2dfd8448b`. This branch is updated after both merges so GitHub regenerates the pull-request merge ref and reruns the complete CI matrix against the current tokenizer implementation. The report writer does not alter kernel execution, but current-master validation remains mandatory before merge.
